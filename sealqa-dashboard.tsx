...
const performanceData = {
  ...
  informationRecency: {
    models: ["GPT-4.1", "O3-MINI", "O3", "LLAMA-4-SCOUT", "DEEPSEEK-R1"],
    categories: ["RECENT", "MODERATE", "OLD"],
    withoutSearch: [
      [28.4, 15.2, 8.9],
      [25.7, 13.8, 6.4],
      [32.1, 18.6, 11.2],
...
const categoryTooltips: Record<string, Record<string, string>> = {
  ...
  informationRecency: {
    RECENT: "Information from the last 6 months",
    MODERATE: "Information from 6 months to 2 years",
    OLD: "Information older than 2 years",
  },
  searchResultQuality: {
        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <header className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">SealQA Performance Analysis</h1>
                <p className="text-lg text-gray-600 mt-1">
                  Interactive dashboard for LLM benchmark evaluation across multiple dimensions
                </p>
              </div>
            </div>
